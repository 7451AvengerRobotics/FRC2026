...
public class AutoRoutines {
  ...
  public Command DF_D2() {
    return Commands.sequence(DF().withTimeout(18), D2());
  }
  ...
  public Command DN_D2() {
    return Commands.sequence(DN().withTimeout(15), D2());
  }
  ...
  public Command DF_Sw() {
    return Commands.sequence(
        Commands.deadline(
            drive.followPPPathCommand("DT-DNZ-F").withTimeout(5.5),
            Commands.sequence(
  ...
  public Command D2_Sw() {
    return Commands.sequence(
        drive.driveToDX2Start().withTimeout(3),
        Commands.deadline(
            drive.followPPPathCommand("DT-DNZ-2").withTimeout(12), superStruc.weirdMasterCommand()),
        scoreWithDriveAlign());
  }
  ...
  public Command S2() {
    return Commands.sequence(
        drive.driveToSX2Start().withTimeout(3),
        Commands.deadline(
  ...
  public Command SF_S2() {
    return Commands.sequence(SF().withTimeout(15), S2());
  }
  ...
  public Command SF_Sw() {
    return Commands.sequence(
        Commands.deadline(
            drive.followPPPathCommand("ST-SNZ-F").withTimeout(5.5),
            Commands.sequence(
                new WaitCommand(0.75),
                Commands.parallel(
                    Commands.sequence(
                    ...
                    Commands.sequence(new WaitCommand(1), superStruc.weirdMasterCommand())))),
        drive.driveToDepotReturn().withTimeout(1),
        drive.followPPPathCommand("SNZ-SB").withTimeout(2.6),
        scoreWithDriveAlign());
  }
  ...
  public Command SN_Sw() {
    return Commands.sequence(
        Commands.deadline(
            drive.followPPPathCommand("ST-SNZ-N").withTimeout(4.5),
            Commands.sequence(
                new WaitCommand(0.75),
                Commands.parallel(
                    Commands.sequence(
