...
public class Drive extends SubsystemBase {
  ...
  public Command driveUnderTrenchToAlliance() {
    if(this.getPose().getY() > 4) {
      return Commands.sequence(this.driveToPose(new Pose2d(5.25, 7.375, new Rotation2d())), this.followPPPathCommand("DepotSideTrenchOpposite"));
    } else {
        return Commands.sequence(this.driveToPose(new Pose2d(5.25, 0.625, new Rotation2d())), this.followPPPathCommand("SourceSideTrenchOpposite"));
    }
  }
