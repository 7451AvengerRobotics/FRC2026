...
public class ShotCalc {
  ...
  public ShotCalc(Transform3d turretOffset) {
    ...
    angleLerp.put(1.0687 + 0.15, 0.2548162392); // 14.6°
    angleLerp.put(1.42 + 0.15, 0.2715680592); // 15.56°
    angleLerp.put(1.87 + 0.15, 0.2858797963); // 16.38°
    angleLerp.put(2.24 + 0.15, 0.3053273467); // 17.5°
    angleLerp.put(2.465 + 0.15, 0.3249698457); // 18.62°
    angleLerp.put(2.7 + 0.15, 0.3403288802); // 19.5°
    angleLerp.put(3.03 + 0.15, 0.3589263261); // 20.56°
    angleLerp.put(3.15 + 0.15, 0.3938758705); // 22.56°
    angleLerp.put(3.3 + 0.15, 0.4099923863); // 23.48°
    angleLerp.put(3.45 + 0.15, 0.4257852268); // 24.39°
    angleLerp.put(3.65 + 0.15, 0.4485343888); // 25.7°
    angleLerp.put(3.84 + 0.15, 0.4669553025); // 26.75°
    angleLerp.put(3.97 + 0.15, 0.4839191944); // 27.727°
    angleLerp.put(4.07 + 0.15, 0.5028848730); // 28.81°
    angleLerp.put(4.15 + 0.15, 0.5152020140); // 29.52°
    angleLerp.put(4.32 + 0.15, 0.5327448563); // 30.53°
    angleLerp.put(4.34 + 0.15, 0.5501223593); // 31.52°
    angleLerp.put(4.41 + 0.15, 0.5860784353); // 33.57°
    angleLerp.put(4.56 + 0.15, 0.6083099749); // 34.85°
    angleLerp.put(4.69 + 0.15, 0.6592155526); // 37.76°
    angleLerp.put(4.63 + 0.15, 0.6835955730); // 39.16°
    angleLerp.put(4.83 + 0.15, 0.7133274470); // 40.87°
    angleLerp.put(4.69 + 0.15, 0.7436549058); // 42.63°
    angleLerp.put(4.94 + 0.15, 0.7940919579); // 45.5°
